...
{\Huge Progress Report 3}} % Title line 3
...
{\raggedleft{}
\textcolor{Red}{
{\large \\ \textsc{Overview:} This progress report features the output of a Python script in IPython Notebook. The input interface has been modified to receive an off-axis resultant stress and output the corresponding stresses and strains based on a pre-defined layup read from a .xlsx file.}}}
\centering
\rule{\textwidth}{0.4pt}\par % Thin horizontal line
\vspace{2pt}\vspace{-\baselineskip} % Whitespace between lines
\rule{\textwidth}{1pt}\par % Thick horizontal line
...
\setcounter{page}{1}
\includepdf[pages={1-5}]{MECH530_Ass3_IPythonNotebook.pdf}
